...
export default function Chat() {
    ...
    const sendMsg = async () =>{
        ...
        if(question){
            ...
            await fetch('/api/chating',{method:'POST',body:JSON.stringify({'prompt':question})}).then((response)=>{
    ...
    return (
        <div className="relative p-2 m-1 shadow shadow-2xl rounded-2xl my-2 outline outline-1 outline-gray-300">
            ...
            <div ref={chatArea} className="my-2 p-3 rounded-2xl h-60 flex flex-col overflow-auto">
            ...
            <div className="my-1 bg-white outline outline-1 outline-gray-300 p-3 rounded-2xl shadow shadow-2xl h-16 flex justify-center items-center">
